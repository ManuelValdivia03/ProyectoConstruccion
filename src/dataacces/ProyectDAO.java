...
public class ProyectDAO implements IProyectDAO {
    ...
    public boolean addProyect(Proyect proyect) throws SQLException {
        String sql = "INSERT INTO proyectos (titulo, descripcion, fecha_inicio, fecha_fin, estado) VALUES (?, ?, ?, ?, ?)";
    ...
    public boolean updateProyect(Proyect proyect) throws SQLException {
        String sql = "UPDATE proyectos SET titulo = ?, descripcion = ?, fecha_inicio = ?, fecha_fin = ?, estado = ? WHERE id_proyecto = ?";
    ...
    public List<Proyect> getAllProyects() throws SQLException {
        String sql = "SELECT id_proyecto, titulo, descripcion, fecha_inicio, fecha_fin, estado FROM proyectos";
    ...
    public Proyect getProyectById(int id) throws SQLException {
        String sql = "SELECT id_proyecto, titulo, descripcion, fecha_inicio, fecha_fin, estado FROM proyectos WHERE id_proyecto = ?";
    ...
    public Proyect getProyectByTitle(String title) throws SQLException {
        String sql = "SELECT id_proyecto, titulo, descripcion, fecha_inicio, fecha_fin, estado FROM proyectos WHERE titulo = ?";
    ...
    public boolean proyectExists(String title) throws SQLException {
        String sql = "SELECT 1 FROM proyectos WHERE titulo = ?";
