...
import userinterface.controllers.ControllerConsultProjectsWindow;

public class ConsultProjectsWindow {
...

                    {
                        ...
                        editBtn.setOnAction(event -> {
                            ...
                            if (getTableView().getProperties().get("controller") != null) {
                                ControllerConsultProjectsWindow controller =
                                        (ControllerConsultProjectsWindow) getTableView().getProperties().get("controller");
